...
procedure TfCadEquipe.AdicionarRegistroPadrao;
begin
  inherited;

  tableRegistroNome.AsString := 'Equipe 1';
  tableRegistro.Post;
end;

procedure TfCadEquipe.CarregarCampos;
begin
  inherited;
  edit1.Text := tableRegistroNome.AsString;
end;

procedure TfCadEquipe.LimparCampos;
begin
  inherited;
  edit1.Text := EmptyStr;
end;

procedure TfCadEquipe.SalvarCadastro;
begin
  inherited;
